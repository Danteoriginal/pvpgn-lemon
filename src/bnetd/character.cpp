...
static t_character_class bncharacter_class_to_character_class(t_uint8 classs)
{
    switch (classs)
    {
...
/* Function unused
static t_uint8 character_class_to_bncharacter_class(t_character_class classs)
{
    switch (classs)
    {
    ...
    default:
	eventlog(eventlog_level_error,__FUNCTION__,"got unknown classs %d",(int)classs);
...
static const char * character_class_to_classname (t_character_class classs)
{
    switch (classs)
    {
    case character_class_amazon:
...
static int load_initial_data (t_character * character, t_character_class classs, t_character_expansion expansion)
{
    ...
    eventlog(eventlog_level_debug,__FUNCTION__,"Initial Data for %s, %s %s",
	     ...
	     character_class_to_classname(classs));
    ...
    data_in_hex = NULL; /* FIXME: what should we do if expansion or classs isn't known... */
...
extern int character_create(t_account * account, t_clienttag clienttag, char const * realmname, char const * name, t_character_class classs, t_character_expansion expansion)
{
    t_character * ch;
    ...
    load_initial_data (ch, classs, expansion);
...
extern t_character_class character_get_class(t_character const * ch)
{
    ...
    return bncharacter_class_to_character_class(ch->classs);
}
...
*/
    ...
    bn_byte_set(&d2char_info.classs,ch->classs);

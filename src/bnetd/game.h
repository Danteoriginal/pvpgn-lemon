...
typedef int t_game_difficulty;
enum {
    game_flag_none,
    game_flag_private
};
typedef int t_game_flag;
typedef struct game
#ifdef GAME_INTERNAL_ACCESS
{
    char const *      name;
...
# include "timer.h"
extern int _isTeamgame(const t_game *game,t_connection *c);

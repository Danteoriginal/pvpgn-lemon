...
static int coefficient(t_account * account, t_clienttag clienttag, t_ladder_id id)
{
    if (account_get_ladder_rating(account,clienttag,id) < 1100)
        return 50;
    else if (account_get_ladder_rating(account,clienttag,id) < 1200)
        return 47;
    else if (account_get_ladder_rating(account,clienttag,id) < 1300)
        return 44;
    else if (account_get_ladder_rating(account,clienttag,id) < 1400)
        return 41;
    else if (account_get_ladder_rating(account,clienttag,id) < 1500)
        return 38;
    else if (account_get_ladder_rating(account,clienttag,id) < 1600)
        return 35;
    else if (account_get_ladder_rating(account,clienttag,id) < 1700)
        return 32;
    else if (account_get_ladder_rating(account,clienttag,id) < 1800)
        return 29;
    else if (account_get_ladder_rating(account,clienttag,id) < 1900)
        return 26;
    else if (account_get_ladder_rating(account,clienttag,id) < 2000)
        return 23;

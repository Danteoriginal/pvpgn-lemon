...
#define gameflag_get_template(gameflag)		BIT_TST_FLAG(gameflag, D2_GAMEFLAG_TEMPLATE)	/* true if use templates settings */
...
extern int game_add_character(t_game * game, char const * charname, 
				unsigned char classs, unsigned char level);

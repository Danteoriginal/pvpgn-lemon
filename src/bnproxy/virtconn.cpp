...
extern t_virtconn * virtconn_create(int csd, int ssd, unsigned int udpaddr, unsigned short udpport)
{
    ...
    temp->classs                 = virtconn_class_none;
...
extern void virtconn_destroy(t_virtconn * vc)
{
    ...
    eventlog(eventlog_level_info,__FUNCTION__,"[%d] closed server connection (%d) classs=%d",vc->ssd,vc->csd,(int)vc->classs);
    eventlog(eventlog_level_info,__FUNCTION__,"[%d] closed client connection (%d) classs=%d",vc->csd,vc->ssd,(int)vc->classs);
...
extern void virtconn_set_class(t_virtconn * vc, t_virtconn_class classs)
{
    if (!vc)
    {
        eventlog(eventlog_level_error,__FUNCTION__,"got NULL virtconn");

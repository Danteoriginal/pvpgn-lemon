...
static int fdw_select_init(int nfds)
{
    ...
    rfds = (fd_set*)xmalloc(sizeof(t_psock_fd_set));
    wfds = (fd_set*)xmalloc(sizeof(t_psock_fd_set));
    trfds = (fd_set*)xmalloc(sizeof(t_psock_fd_set));
    twfds = (fd_set*)xmalloc(sizeof(t_psock_fd_set));

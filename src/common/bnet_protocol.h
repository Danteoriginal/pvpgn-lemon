...
/******************************************************/
/*
14: recv classs=w3route[0x0c] type=unknown[0x00f7] length=53
...
/******************************************************/
/*
13: recv classs=w3route[0x0c] type=unknown[0x2ef7] length=107
 ...
 * messages.  109 fixes it because they introduced new_ packets to replace
 * these. */
...
/******************************************************/
/*
# 44 packet from server: type=0x40ff(unknown) length=40 classs=bnet
...
*/
    ...
    bn_byte unknownb10;
    bn_byte unknownb11;
    bn_byte classs;     /* 0x01=Amazon, 0x02=Sor, 0x03=Nec, 0x04=Pal, 0x05=Bar */
...
/******************************************************/
/*
# 21 packet from client: type=0x46ff(unknown) length=8 classs=bnet
...
/******************************************************/
/*
# 22 packet from server: type=0x46ff(unknown) length=225 classs=bnet
...
# Match 4, 2002
# 92 packet from server: type=0x46ff(unknown) length=859 classs=bnet
0000:   FF 46 5B 03 01 B4 B2 82   3C 20 B6 83 3C 20 B6 83    .F[.....< ..< ..
0010:   3C 20 B6 83 3C 57 65 20   68 61 76 65 20 62 65 65    < ..<We have bee
# 93 packet from server: type=0x46ff(unknown) length=223 classs=bnet
...
/*
# Jon/bbbbb
# 28 packet from client: type=0x53ff(unknown) length=40 classs=bnet
...
# 34 packet from server: type=0x54ff(unknown) length=40 classs=bnet
...
/******************************************************/
/* 
# 13 packet from client: type=0x52ff(unknown) length=83 classs=bnet
...
/*
# 20 packet from client: type=0x45ff(unknown) length=6 classs=bnet
...
/******************************************************/
/* Diablo II 1.03 */
/* sent when registering new_ player with open Battle.net */
...
(open) b.net login:
 ...
 "Create new_ account" -> TOS grab -> Enter password -> 3dff packet
*/
/*
 ...
 *  client tag (LTRD)
 *  level
 *  classs (0==warrior, 1==rogue, 2==sorcerer)
...
/*      System operator */
#define MF_BNET     0x00000008 /* (old: blue Blizzard, new_: green b.net) or red BNETD logo */
...
# war3
# 66 packet from server: type=0x09ff(SERVER_GAMELISTREPLY) length=131 classs=bnet
...
This seems to be associated with a UDP packet 7 from the client:
 7: cli classs=bnet[0x01] type=CLIENT_PINGREQ[0x00ff] length=4
 0000:   FF 00 04 00                                          ....
 5: clt prot=udp[0x07] from=128.123.62.23:6112 to=128.123.62.23:6112 length=8
 0000:   07 00 00 00 2E 95 9D 00                              ........
 7: srv classs=bnet[0x01] type=SERVER_PINGREPLY[0x00ff] length=4
 0000:   FF 00 04 00                                          ....
...
*/
/*
300: recv classs=bnet[0x02] type=unknown[0x70ff] length=12
0000:   FF 70 0C 00 01 00 00 00   00 64 73 66                .p.......dsf    
300: send classs=bnet[0x02] type=unknown[0x70ff] length=56
...
300: recv classs=bnet[0x02] type=CLIENT_FRIENDINFOREQ[0x66ff] length=5
0000:   FF 66 05 00 01                                       .f...           
300: send classs=bnet[0x02] type=unknown[0x66ff] length=12
0000:   FF 66 0C 00 01 00 00 00   00 00 00 00                .f..........    
300: recv classs=bnet[0x02] type=unknown[0x71ff] length=64
...
300: send classs=bnet[0x02] type=unknown[0x71ff] length=10
0000:   FF 71 0A 00 01 00 00 00   00 00                      .q........      
300: send classs=bnet[0x02] type=unknown[0x75ff] length=12
...
/*
3852: recv classs=bnet[0x02] type=unknown[0x71ff] length=70
...
typedef struct{
  ...
  // bn_int			    clantag;
  // bn_byte			friend_count; //Number of friend_ selected
  // Name of friend_ (\0 terminated string)
} PACKED_ATTR() t_client_w3xp_clan_createinvitereq;

/*3756: send classs=bnet[0x02] type=unknown[0x71ff] length=14
...
/*
3876: recv classs=bnet[0x02] type=unknown[0x73ff] length=8
...
/*
3876: recv classs=bnet[0x02] type=unknown[0x77ff] length=13
